...
abstract class Categorie implements ActiveRecordInterface
{
    ...
    public function setIdCategorie($v)
    {
        ...
        if ($this->idcategorie !== $v) {
            $this->idcategorie = $v;
            $this->modifiedColumns[CategorieTableMap::COL_IDCATEGORIE] = true;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[CategorieTableMap::COL_LIBELLE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CategorieTableMap::translateFieldName('IdCategorie', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idcategorie = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CategorieTableMap::translateFieldName('Libelle', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = CategorieTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategorieTableMap::COL_IDCATEGORIE)) {
            $modifiedColumns[':p' . $index++]  = 'idCategorie';
        }
        if ($this->isColumnModified(CategorieTableMap::COL_LIBELLE)) {
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdCategorie($arr[$keys[0]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategorieTableMap::COL_IDCATEGORIE)) {
            $criteria->add(CategorieTableMap::COL_IDCATEGORIE, $this->idcategorie);
        }
        if ($this->isColumnModified(CategorieTableMap::COL_LIBELLE)) {
            $criteria->add(CategorieTableMap::COL_LIBELLE, $this->libelle);
        }
    ...
    {
        $validPk = null !== $this->getIdCategorie();
     ...
     * @return ObjectCollection|ChildArticle[] List of ChildArticle objects
     */
    public function getArticlesJoinTauxTVA(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildArticleQuery::create(null, $criteria);
        $query->joinWith('TauxTVA', $joinBehavior);
