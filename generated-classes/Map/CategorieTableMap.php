...
class CategorieTableMap extends TableMap
{
     ...
     */
    const COL_IDCATEGORIE = 'categorie.idCategorie';

    /**
     * the column name for the libelle field
     */
    const COL_LIBELLE = 'categorie.libelle';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCategorie', 'Libelle', ),
        self::TYPE_CAMELNAME     => array('idCategorie', 'libelle', ),
        self::TYPE_COLNAME       => array(CategorieTableMap::COL_IDCATEGORIE, CategorieTableMap::COL_LIBELLE, ),
        self::TYPE_FIELDNAME     => array('idCategorie', 'libelle', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCategorie' => 0, 'Libelle' => 1, ),
        self::TYPE_CAMELNAME     => array('idCategorie' => 0, 'libelle' => 1, ),
        self::TYPE_COLNAME       => array(CategorieTableMap::COL_IDCATEGORIE => 0, CategorieTableMap::COL_LIBELLE => 1, ),
        self::TYPE_FIELDNAME     => array('idCategorie' => 0, 'libelle' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('idCategorie', 'IdCategorie', 'INTEGER', true, null, null);
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdCategorie', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdCategorie', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdCategorie', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdCategorie', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdCategorie', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdCategorie', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        return (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('IdCategorie', TableMap::TYPE_PHPNAME, $indexType)
        ];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CategorieTableMap::COL_IDCATEGORIE);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CategorieTableMap::COL_IDCATEGORIE, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(CategorieTableMap::COL_IDCATEGORIE) && $criteria->keyContainsValue(CategorieTableMap::COL_IDCATEGORIE) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.CategorieTableMap::COL_IDCATEGORIE.')');
        }
